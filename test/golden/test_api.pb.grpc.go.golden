...
type TestAPIClient interface {
	...
	FirstMethod(ctx context.Context, in *FirstMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// SecondMethod tests second method.
	SecondMethod(ctx context.Context, in *SecondMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *testAPIClient) FirstMethod(ctx context.Context, in *FirstMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/qrpc.test.api.TestAPI/FirstMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testAPIClient) SecondMethod(ctx context.Context, in *SecondMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/qrpc.test.api.TestAPI/SecondMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestAPIServer interface {
	// FirstMethod tests first method.
	FirstMethod(context.Context, *FirstMethodRequest) (*empty.Empty, error)
	// SecondMethod tests second method.
	SecondMethod(context.Context, *SecondMethodRequest) (*empty.Empty, error)
}
...
func (*UnimplementedTestAPIServer) FirstMethod(ctx context.Context, req *FirstMethodRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FirstMethod not implemented")
}
func (*UnimplementedTestAPIServer) SecondMethod(ctx context.Context, req *SecondMethodRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SecondMethod not implemented")
}
...
func _TestAPI_FirstMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qrpc.test.api.TestAPI/FirstMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestAPIServer).FirstMethod(ctx, req.(*FirstMethodRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TestAPI_SecondMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qrpc.test.api.TestAPI/SecondMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestAPIServer).SecondMethod(ctx, req.(*SecondMethodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
